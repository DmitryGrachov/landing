...
const panels: Panel[] = [
  {
    ...
    anchor: [50, 50],
    content: (
      <div className="w-[clamp(132px,30vw,192px)]">
...
export default function HeroVisual() {
  return (
    <div className="relative mx-auto aspect-[1/0.92] w-full max-w-[640px]">
      ...
      >
        <div className="relative flex h-[168px] w-[168px] items-center justify-center sm:h-[200px] sm:w-[200px]">
      ...
      {panels.map((p) => (
        <motion.div
          key={p.id}
          className="glass absolute rounded-2xl p-3.5 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.7)]"
