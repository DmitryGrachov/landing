...
const faqs = [
  ...
  },
  {
    ...
    a: "Нет. INEGO.dev подключается к вашей текущей CRM и инструментам продаж, а не заменяет их. Активность покупателей, брони и аналитика поступают в те системы, которыми уже пользуется команда.",
  },
  {
  ...
  {
    q: "Кто создаёт цифровую сцену — мы или INEGO.dev?",
  ...
  },
  {
    ...
    a: "Да. INEGO.dev часто подключают в середине цикла продаж, чтобы вернуть потерянные лиды и дать отделу продаж полную картину по проекту, который уже в продаже.",
  },
  {
